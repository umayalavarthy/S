  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved branch as @branch" do
        ...
        post :create, {:branch => { "name" => "invalid value" }}, valid_session
        assigns(:branch).should be_a_new(Branch)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested branch" do
        ...
        Branch.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => branch.to_param, :branch => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the branch as @branch" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Branch.any_instance.stub(:save).and_return(false)
        put :update, {:id => branch.to_param, :branch => { "name" => "invalid value" }}, valid_session
        assigns(:branch).should eq(branch)
      end
